...
import { MagnifyingGlassIcon, FireIcon, ClockIcon, TrendingUpIcon, Squares2X2Icon, ClockIcon as HistoryIcon } from '@heroicons/react/24/outline'
...
export default function SearchAndFilters({ onSearch, onFilter }) {
  ...
  const filters = [
    ...
    { id: 'trending', label: '升序', icon: TrendingUpIcon, bgColor: 'bg-yellow-400 hover:bg-yellow-500' },
