  ...
  return (
    <div className="relative z-10">
      ...
      <img 
        ...
        src="https://via.placeholder.com/200x200/FFB6C1/FFFFFF?text=🐱"
      />
      <img 
        alt="cute pet" 
        className="absolute -bottom-16 -right-12 w-64 opacity-80 rotate-[20deg] z-0" 
        src="https://via.placeholder.com/250x250/87CEEB/FFFFFF?text=🐶"
      />
      ...
      <div className="text-center mb-16 relative z-10">
        ...
        <p className="text-2xl text-gray-700 font-fredoka">Built for community, by community</p>
      </div>
    </div>
  );
};
