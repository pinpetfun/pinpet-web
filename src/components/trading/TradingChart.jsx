...
const TradingChart = ({ tokenName = "BRONK", tokenPrice = "0.0000007411", mintAddress }) => {
  // 获取 mintInfo 数据
  ...
  // 使用WebSocket Context
  const { connectionStatus, klineData, currentPrice, subscribe, unsubscribe, getHistoryData, clearData } = useWebSocket();
